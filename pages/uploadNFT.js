    ...
    <div className={Style.uploadNFT}>
      <div className={Style.uploadNFT_box}>
        <div className={Style.uploadNFT_box_heading}>
          ...
          <p>
            Hãy luôn cẩn trọng trong quá trình tìm việc và chủ động nghiên cứu
            về thông tin công ty, vị trí việc làm trước khi ứng tuyển.
          </p>
        </div>

        <div className={Style.uploadNFT_box_title}>
          <h2>Tải lên tại đây</h2>
          <p>Hỗ trợ định dạng ảnh có kích thước dưới 5MB.</p>
        </div>
